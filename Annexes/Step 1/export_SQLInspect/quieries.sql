...
CREATE TABLE IF NOT EXISTS USER_ACCOUNT (USER_ID TEXT,
...
CREATE TABLE IF NOT EXISTS STATUSES_STORED (ID INTEGER PRIMARY KEY AUTO_INCREMENT,
...
ACCT TEXT NOT NULL,
INSTANCE TEXT NOT NULL,
TARGETED_USER_ID TEXT NOT NULL,
DATE_CREATION TEXT NOT NULL,
DATE_END TEXT NOT NULL);

CREATE TABLE IF NOT EXISTS STATUSES_CACHE (ID INTEGER PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS USER_ACCOUNT_TEMP (USER_ID TEXT,
USERNAME TEXT NOT NULL,
ACCT TEXT NOT NULL,
DISPLAYED_NAME TEXT NOT NULL,
LOCKED INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS INSTANCES (ID INTEGER PRIMARY KEY AUTO_INCREMENT,
INSTANCE TEXT NOT NULL,
USER_ID TEXT NOT NULL,
...
---------------------------- ADD implicit FKs (enriched)

alter table NOTIFICATION_CACHE add constraint NOTIFICATION_CACHE_REF_USER_ACCOUNT_FK
     foreign key (USER_ID) references USER_ACCOUNT (USER_ID);
	 
alter table TIMELINE_CACHE add constraint TIMELINE_CACHE_REF_USER_ACCOUNT_FK
     foreign key (USER_ID) references USER_ACCOUNT (USER_ID);
	 
alter table INSTANCES add constraint INSTANCES_REF_USER_ACCOUNT_FK
     foreign key (USER_ID) references USER_ACCOUNT (USER_ID);
	 
alter table MAIN_MENU_ITEMS add constraint MAIN_MENU_ITEMS_REF_USER_ACCOUNT_FK
     foreign key (USER_ID) references USER_ACCOUNT (USER_ID);
	 
alter table STATUSES_CACHE add constraint STATUSES_CACHE_REF_USER_ACCOUNT_FK
     foreign key (USER_ID) references USER_ACCOUNT (USER_ID);

alter table TIMELINES add constraint TIMELINES_REF_USER_ACCOUNT_FK
     foreign key (USER_ID) references USER_ACCOUNT (USER_ID);
	 
alter table SEARCH add constraint SEARCH_REF_USER_ACCOUNT_FK
     foreign key (USER_ID) references USER_ACCOUNT (USER_ID);
	 
alter table STATUSES_STORED add constraint STATUSES_STORED_REF_USER_ACCOUNT_FK
     foreign key (USER_ID) references USER_ACCOUNT (USER_ID);
--- 
alter table USER_NOTES add constraint USER_NOTES_REF_USER_ACCOUNT_FK
     foreign key (ACCT) references USER_ACCOUNT (ACCT);	
alter table TEMP_MUTE add constraint TEMP_MUTE_REF_USER_ACCOUNT_FK
     foreign key (ACCT) references USER_ACCOUNT (ACCT);	 
